...
int main(int argc, char** argv) {
	...
	PowerUp powerUp4 = PowerUp(pm, Model("models/powerups/jump_star.obj"), PowerUpType::eJUMP, PxVec3(77.f, 20.f, -113.f));
	...
	PowerUp powerUp6 = PowerUp(pm, Model("models/powerups/shield/shieldman.obj"), PowerUpType::eSHIELD, PxVec3(-134, 23.f, 0.f));
	PowerUp powerUp7 = PowerUp(pm, Model("models/powerups/health_star.obj"), PowerUpType::eHEALTH, PxVec3(0.f, 90.f, 0.f));
